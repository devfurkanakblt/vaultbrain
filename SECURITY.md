...
- affected surface: CLI, MCP, desktop/webview, Rust core, plugin or sync;
- prerequisites, including whether the attacker knows the passphrase or acts as
  the logged-in OS user;
- impact and the confidentiality, integrity or availability boundary crossed;
- minimal reproduction steps using synthetic data;
- relevant logs or stack traces with vault paths, secrets and personal data
  removed;
