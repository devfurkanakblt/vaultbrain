...
mod tests {
    ...
    fn release_urls_are_bound_to_the_versioned_fixed_repository() {
        ...
        for rejected in [
            ...
            "https://github.com/devfurkanakblt/vaultbrain/releases/download/v0.3.0/%2e%2e%2fsetup.deb".to_string(),
            "https://github.com/devfurkanakblt/vaultbrain/releases/download/v0.3.0/%5csetup.deb".to_string(),
